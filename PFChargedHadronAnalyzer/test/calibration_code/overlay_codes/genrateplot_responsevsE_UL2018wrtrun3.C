#include <stdio.h>
// #include<conio.h>
void genrateplot_responsevsE_UL2018wrtrun3(TString legendname, TString plot_name,  TString plot_name2)
{
  TString hname,hname1,pdf="plots/pdf/"+plot_name+".pdf",gif="plots/gif/"+plot_name+".gif",png="plots/png/"+plot_name+".png";
  bool xaxis_pt=false;
  TString path_root2="usingRun3/response/";
  //  path_root2="../../Run3/raw/response/";
  //  path_root2="../../Run3/trial2/response/";

  TString path_root1="trial3/response/";
  //  path_root1="./";   
  //  pdf="trial3/plots/pdf/Old_"+plot_name2+".pdf";gif="trial3/plots/gif/Old_"+plot_name2+".gif";png="trial3/plots/png/Old_"+plot_name2+".png";
  //  pdf="trial3/plotsv2/Old_"+plot_name2+".pdf";gif="trial3/plotsv2/Old_"+plot_name2+".gif";png="trial3/plotsv2/Old_"+plot_name2+".png";
  ...
  Canvas_1_n2->Divide(2,1);
   ...
   TLegend* legends = new TLegend(0.3, 0.72, 0.9, 0.9,"","brNDC"); // the numbers determine the position of the box 
   //   TLegend* legends = new TLegend(0.4, 0.1, 0.9, 0.3,"","brNDC"); // the numbers determine the position of the box 
   ...
   //   legends->AddEntry(graph1,"corr E (UL2018 param. + Run3 GT)","P");
   //legends->AddEntry(graph2,"corr E (trial2 param. + Run3 GT)","P");
   legends->AddEntry(graph1,"New calib (Run3v2 with PU)","P");
   legends->AddEntry(graph2,"Old calib (Run3)","P");

   //legends->AddEntry(graph1,"New calib on Run3v2PU sample","P");
   //legends->AddEntry(graph2,"Old calib on Run3 sample","P");

      //   legends->AddEntry(graph1,"corr E (Run3v2 with PU)","P");
   //   legends->AddEntry(graph2,"corr E (Run3)","P"); 
   legends->SetTextSize(0.036);
