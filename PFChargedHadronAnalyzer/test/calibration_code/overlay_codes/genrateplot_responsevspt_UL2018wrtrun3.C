#include <stdio.h>
// #include<conio.h>
void genrateplot_responsevspt_UL2018wrtrun3(TString legendname, TString plot_name,  TString plot_name2)
{
  TString hname,hname1,pdf="plots/pdf/"+plot_name+".pdf",gif="plots/gif/"+plot_name+".gif",png="plots/png/"+plot_name+".png";
  bool xaxis_pt=false;
  TString path_root2="usingRun3/response_pt/";
  //  TString path_root1="./";
  TString path_root1="trial3/response_pt/";
  //  pdf="trial2/plots/pdf/"+plot_name+"_pt.pdf";gif="trial2/plots/gif/"+plot_name+"_pt.gif";png="trial2/plots/png/"+plot_name+"_pt.png";
  ...
  pdf="trial3/plotsv2/Oldwrttrial3/Old_"+plot_name+"_pt.pdf";gif="trial3/plotsv2/Oldwrttrial3/Old_"+plot_name+"_pt.gif";png="trial3/plotsv2/Oldwrttrial3/Old_"+plot_name+"_pt.png";
  ...
  Canvas_1_n2->Divide(2,1);
   ...
   TLegend* legends = new TLegend(0.3, 0.7, 0.9, 0.9,"","brNDC"); // the numbers determine the position of the box 
   ...
   //   legends->AddEntry(graph1,"New calib (Run3)","P");
   // legends->AddEntry(graph2,"Old calib (UL2018)","P");
