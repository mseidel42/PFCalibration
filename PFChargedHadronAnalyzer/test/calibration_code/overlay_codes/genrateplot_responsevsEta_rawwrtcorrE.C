#include <stdio.h>
// #include<conio.h>
void genrateplot_responsevsEta_rawwrtcorrE(TString legendname, TString plot_name,  TString plot_name2, TString dir)
{
  ...
  //pdf="trial/plots/pdf/"+plot_name+".pdf";gif="trial/plots/gif/"+plot_name+".gif";png="trial/plots/png/"+plot_name+".png";
    ...
    //    TString path_root2=dir+"/response/";
    //pdf=dir+"/plots/pdf/Raw_"+plot_name+".pdf";gif=dir+"/plots/gif/Raw_"+plot_name+".gif";png=dir+"/plots/png/Raw_"+plot_name+".png";
  ...
  //Canvas_1_n2->Divide(2,1);
   ...
   Graph_Graph01->GetYaxis()->SetTitleSize(0.045);
   ...
   TLegend* legends = new TLegend(0.15, 0.75, 0.9, 0.9,"","brNDC"); // the numbers determine the position of the box 
   ...
   legends->AddEntry(graph1,"After E corr","P");
   legends->AddEntry(graph2,"After Eta dep. corr","P");
   //   legends->AddEntry(graph2,"corr E (UL2018 param. + Run3 GT)","P");
   legends->SetTextSize(0.045);
