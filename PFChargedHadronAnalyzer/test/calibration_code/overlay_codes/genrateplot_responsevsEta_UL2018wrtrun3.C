...
void genrateplot_responsevsEta_UL2018wrtrun3(TString legendname, TString plot_name,  TString plot_name2)
{
  ...
  //  pdf="trial3/plots/pdf/Old_"+plot_name+".pdf";gif="trial3/plots/gif/Old_"+plot_name+".gif";png="trial3/plots/png/Old_"+plot_name+".png";
  ...
  //  TString path_root2="trial1/response/";
  ...
  //Canvas_1_n2->Divide(2,1);
   ...
   legends->AddEntry(graph1,"New calib (Run3_v2 with PU)","P");
