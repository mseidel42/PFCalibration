...
config.General.requestName = 'PGun_step3_RECO_1264_2_200_usingGTRun3v2_noPU'
...
config.Data.outLFNDirBase = '/store/user/bkansal/step3_ana/PGun_step3_RECO_1264_2_200_usingGTRun3v2_noPU/'
